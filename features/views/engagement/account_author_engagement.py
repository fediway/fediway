...
for spec in SPECS:
    feature_views.append(
        make_feature_view(
            f"account_author_engagement_{spec}",
            entities=[account, author],
            schema=FEATURES,
            online=True,
            tags={
                "online_store": f"online_features_account_author_engagement_{spec}",
                "offline_store": f"offline_features_account_author_engagement_{spec}",
            },
