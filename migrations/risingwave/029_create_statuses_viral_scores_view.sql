...
FROM status_engagement_features e_curr
JOIN status_engagement_features e_all ON e_all.status_id = e_curr.status_id
WHERE e_curr.window_start < NOW() - INTERVAL '60 MINUTES'
