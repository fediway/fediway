...
JOIN enriched_status_engagement_events e2 ON e1.status_id = e2.status_id
...
FROM enriched_status_engagement_events e1
JOIN enriched_status_engagement_events e2 ON e1.account_id = e2.account_id
WHERE e1.status_id < e2.status_id
  AND e1.event_time > NOW() - INTERVAL '3 DAYS'
  AND e2.event_time > NOW() - INTERVAL '3 DAYS'
