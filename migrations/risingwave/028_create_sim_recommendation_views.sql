...
FROM (
	SELECT 
		...
		MAX(sim.common_accounts) AS score
	FROM accounts a
...
DROP SINK IF EXISTS status_sim_recommendations;
DROP VIEW IF EXISTS account_sim_recommendations;
DROP VIEW IF EXISTS status_sim_recommendations;